...
| **F5-S04** | Endurecimento de sessão, schema e contrato     | ✅     | #31 | 2026-09-09 | 13, 16, 19, 20, 23, 26         |
...
| ~~P6~~ | ~~Achado **R-01** — a ponte do Better Auth resolve o IP só por header; `session.ip_address` e as 8 regras de rate limit de auth são falsificáveis fora da borda~~ | —                             | ✅ **resolvido 2026-09-09** em F5-S04 (§3.3, §5.7, T29–T33, PR #31)                                                                                         |
